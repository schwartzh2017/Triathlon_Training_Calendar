...
**Color rules:**
- Sport colors are the dominant accent palette — swim, bike, run, strength, pilates, plyometrics, sauna, and contrast therapy each own their color and it is used consistently everywhere they appear
